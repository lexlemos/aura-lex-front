  ...
  return (
    <div className="relative w-full">
      ...
      <form
        ...
        {...dragHandlers}
        className={`relative bg-white dark:bg-zinc-900 border rounded-2xl shadow-2xl flex flex-col p-2.5 transition-all duration-200 focus-within:ring-2 focus-within:ring-indigo-500/20 dark:focus-within:ring-indigo-400/20 ${
          isDragActive 
      ...
      >
        ...
        <div className="flex items-end gap-2">
          ...
          {/* Botão de Clipe para Anexo */}
          <button
            type="button"
            onClick={triggerFileInput}
            disabled={isGenerating}
            className="h-10 w-10 rounded-xl text-zinc-400 hover:text-zinc-650 hover:bg-zinc-100 dark:text-zinc-500 dark:hover:text-zinc-300 dark:hover:bg-zinc-800 flex items-center justify-center transition-all shrink-0 cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed"
          ...
          <button
            ...
            className="h-10 w-10 rounded-xl bg-indigo-650 hover:bg-indigo-700 dark:bg-indigo-500 dark:hover:bg-indigo-600 text-white flex items-center justify-center transition-all shrink-0 shadow-md cursor-pointer disabled:bg-zinc-100 dark:disabled:bg-zinc-800 disabled:text-zinc-400 dark:disabled:text-zinc-600 disabled:shadow-none disabled:cursor-not-allowed"
